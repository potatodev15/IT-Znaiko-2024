...
import pyramid from '../assets/egypt-cat.png'
import styles from './style'

const Symbol = () => {
  return (
    <div className='w-full h-[120vh] bg-default flex items-center font-text text-primary' id='symbol'>
        <div className='w-[1240px] h-[80%] mx-auto flex flex-col justify-center gap-10 items-center text-center'>
            <img src={pyramid} alt="" className='w-[800px]'/>
