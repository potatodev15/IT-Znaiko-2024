...
import cat from '../assets/family.png'
import { CiDesktopMouse2 } from "react-icons/ci";

const Family = () => {
  return (
    <div className='w-full h-[120vh] flex flex-col justify-center items-center bg-default text-primary font-text' id='family'>
        <div className='max-w-[1240px] h-full mx-auto grid md:grid-cols-2 md:gap-10 gap-0 pt-[80px]'>
            ...
            <div className='w-[100%] h-[90%] flex flex-col justify-center items-center'>
              <img src={cat} alt="/" className='z-[0] w-full transform -scale-x-100'/>
            </div>
        </div>
    </div>
  )
