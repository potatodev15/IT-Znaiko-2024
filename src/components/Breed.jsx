...
const Breed = () => {
  return (
    <div className='w-full h-[250vh] md:h-[170vh] bg-gray-500 flex justify-center items-center'>
        <div className='w-[1240px] h-[80%] mx-auto flex flex-col items-center gap-10 bg-blue-500'>
            <div className='flex flex-col text-center p-5 gap-5'>
                <h1 className='text-6xl'>Най-известните породи за 2023</h1>
            ...
            <div className='w-full h-full flex flex-wrap md:flex-nowrap flex-row justify-between items-center gap-20'>
                <div className='max-w-[600px] h-[500px] text-center bg-green-500 flex flex-col justify-evenly items-center  p-10'>
                    <img src={cat1} alt="" />
                    <h1>Персийска котка</h1>
                    <p>
